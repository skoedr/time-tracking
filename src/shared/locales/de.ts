...
export const de = {
  ...
  // v1.11 #94 — Stammdaten
  'clients.form.billingAddressLabel': 'Rechnungsadresse',
  'clients.form.billingLine1Placeholder': 'Straße und Hausnummer',
  'clients.form.billingLine2Placeholder': 'Adresszusatz (optional)',
  'clients.form.billingLine3Placeholder': 'PLZ und Ort',
  'clients.form.billingLine4Placeholder': 'Land (optional)',
  'clients.form.vatIdLabel': 'Umsatzsteuer-ID',
  'clients.form.vatIdPlaceholder': 'z.B. DE123456789',
  'clients.form.contactPersonLabel': 'Ansprechpartner',
  'clients.form.contactPersonPlaceholder': 'z.B. Max Mustermann',
  'clients.form.contactEmailLabel': 'Kontakt-E-Mail',
  'clients.form.contactEmailPlaceholder': 'z.B. max@example.com',
  ...
  'projects.pausedSection': 'Pausiert ({count})',
  ...
  // v1.11 #94 — Stammdaten
  'projects.form.externalNumberLabel': 'Externe Projektnummer',
  'projects.form.externalNumberPlaceholder': 'z.B. PO-2026-001',
  'projects.form.startDateLabel': 'Startdatum',
  'projects.form.endDateLabel': 'Enddatum',
  'projects.form.budgetLabel': 'Budget (Stunden)',
  'projects.form.budgetPlaceholder': 'z.B. 40',
  'projects.form.budgetHint': 'Optionales Stundenbudget (Dezimalstunden, z.B. 40,5 = 40h 30min).',
  ...
  'export.ical.showClientName': 'Kundenname im Titel',
  'export.ical.showClientNameHint':
    'An: Titel = Kunde (+ Projekt) und Beschreibung. Aus: nur ein generisches „Fokus" — auch Beschreibung und Tags bleiben dann weg.',
  'export.ical.privacyNote': 'Honorare und interne Notizen erscheinen nie im Kalender.',
  ...
  'export.footer.icalHint':
    'Erzeugt eine .ics-Datei zum Import in jeden Kalender (Zeiten in UTC, DST-sicher).',
  ...
  'export.status.icalCreating': 'iCal wird erstellt …',
  'export.status.icalSaved': 'iCal gespeichert: {path}',
  ...
  'export.button.ical': 'iCal speichern',
  ...
  // ── Kalender-Import (#130c) ─────────────────────────────────────────────
  'calendarImport.button': 'Termine übernehmen',
  'calendarImport.title': 'Termine übernehmen',
  'calendarImport.from': 'Von',
  'calendarImport.to': 'Bis',
  'calendarImport.load': 'Termine laden',
  ...
  'calendarImport.doneAllFailed': 'Kein Termin übernommen.',
  'calendarImport.skipped': '{count} Termin(e) ausgeblendet:',
  'calendarImport.skipReason.cancelled': 'abgesagt',
  'calendarImport.skipReason.allDay': 'ganztägig',
  'calendarImport.skipReason.declined': 'abgelehnt',
  'calendarImport.skipReason.free': 'als frei markiert',
  'calendarImport.skipReason.noId': 'ohne Termin-ID',
  'calendarImport.skipReason.noTimes': 'ohne verwertbare Zeiten',
  'calendarImport.skipReason.alreadyImported': 'bereits übernommen',

...
export const en: Record<TranslationKey, string> = {
  ...
  'projects.pausedSection': 'Paused ({count})',
  ...
  'export.ical.showClientName': 'Client name in title',
  'export.ical.showClientNameHint':
    'On: title = client (+ project) and description. Off: a generic "Focus" only — description and tags are omitted too.',
  'export.ical.privacyNote': 'Fees and private notes never appear in the calendar.',
  ...
  'export.footer.icalHint':
    'Creates an .ics file to import into any calendar (times in UTC, DST-safe).',
  ...
  'export.status.icalCreating': 'Creating iCal …',
  'export.status.icalSaved': 'iCal saved: {path}',
  ...
  'merge.sn.add': 'Add another time report …',
  'merge.sn.remove': 'Remove',
  'merge.sn.slotSingle': 'Time report',
  'merge.sn.slot': 'Time report #{n}',
  ...
  'merge.preview.multi': 'Invoice ({inv}) + {count} time reports ({sn}) = {total} pages',
  ...
  // ── Calendar import (#130c) ─────────────────────────────────────────────
  'calendarImport.button': 'Import appointments',
  'calendarImport.title': 'Import appointments',
  'calendarImport.from': 'From',
  'calendarImport.to': 'To',
  'calendarImport.load': 'Load appointments',
  'calendarImport.loading': 'Loading appointments …',
  'calendarImport.empty': 'No open appointments in this range.',
  'calendarImport.clientPlaceholder': 'Choose client …',
  'calendarImport.projectPlaceholder': 'No project',
  'calendarImport.hint.noDomain': 'No external attendees — please choose a client.',
  'calendarImport.hint.unknownDomain': 'Unknown domain — please choose a client.',
  'calendarImport.hint.ambiguous': 'Attendees from several known clients — please choose a client.',
  'calendarImport.learn': 'Assign {domain} to this client from now on',
  'calendarImport.learnWithProject': 'Assign {domain} to this client and project from now on',
  'calendarImport.import': 'Import ({count})',
  'calendarImport.importing': 'Importing …',
  'calendarImport.done': '{created} of {total} appointments imported.',
  'calendarImport.doneAllFailed': 'No appointment was imported.',
  'calendarImport.skipped': '{count} appointment(s) hidden:',
  'calendarImport.skipReason.cancelled': 'cancelled',
  'calendarImport.skipReason.allDay': 'all-day',
  'calendarImport.skipReason.declined': 'declined',
  'calendarImport.skipReason.free': 'marked as free',
  'calendarImport.skipReason.noId': 'without an event id',
  'calendarImport.skipReason.noTimes': 'without usable times',
  'calendarImport.skipReason.alreadyImported': 'already imported',
  ...
  'settings.webhooks.desc':
    'Send an HTTP POST to one or more URLs on timer and entry events — e.g. to drive an automation or another system. Delivery happens in the background and never affects the timer.',
  'settings.webhooks.empty': 'No webhook targets configured yet.',
  'settings.webhooks.addTarget': 'Add target',
  'settings.webhooks.target': 'Target {n}',
  'settings.webhooks.url': 'URL',
  'settings.webhooks.urlInvalid': 'Enter a valid http(s) URL — otherwise nothing is sent.',
  'settings.webhooks.secret': 'Secret (optional)',
  'settings.webhooks.secretHint':
    'When set, every message is signed with HMAC-SHA256 (X-TimeTrack-Signature header). Stored in plain text in the local database.',
  'settings.webhooks.events': 'Events',
  'settings.webhooks.enabled': 'Enabled',
  'settings.webhooks.remove': 'Remove',
  'settings.webhooks.event.timerStarted': 'Timer started',
  'settings.webhooks.event.timerStopped': 'Timer stopped',
  'settings.webhooks.event.entryCreated': 'Entry created',
  'settings.webhooks.event.entryUpdated': 'Entry updated',
  'settings.webhooks.deliveryLog': 'Delivery log',
  'settings.webhooks.deliveryLogHint':
    'Every delivery is logged to webhooks.log — without the secret or signature.',
  'settings.webhooks.openLog': 'Open log folder',
